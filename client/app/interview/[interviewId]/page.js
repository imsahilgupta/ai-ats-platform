                ...
                <div className='interview-layout'>
                    ...
                    <aside className='interview-sidebar'>
                        ...
                        <div className='match-score-widget'>
                            <p className='match-score-widget__label'>Match Score</p>
                            <div className={`match-score-widget__ring ${scoreColor}`}>
                                <span className='match-score-widget__value'>{report.matchScore || 0}</span>
                                <span className='match-score-widget__pct'>%</span>
                            </div>
                            <p className='match-score-widget__sub'>Strong match for this role</p>
                        </div>
