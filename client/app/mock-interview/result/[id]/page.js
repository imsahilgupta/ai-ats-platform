              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div className="interview-card" style={{ padding: '2rem' }}>
                  <h2 style={{ fontSize: '1.3rem', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="2.5">
                      <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                    </svg>
                    AI Coach Evaluation Summary
                  </h2>
                  <div style={{ lineHeight: '1.7', color: 'var(--text-muted)', fontSize: '1.05rem', whiteSpace: 'pre-wrap' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                  ...
                  <div className="interview-card" style={{ padding: '1.5rem' }}>
                    <h3 style={{ fontSize: '1rem', color: 'var(--text-muted)', margin: '0 0 1rem 0', textTransform: 'uppercase' }}>Filler Words Density</h3>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                      <span style={{ fontSize: '2.5rem', fontWeight: 'bold', color: comm.fillerWordsCount > 4 ? 'var(--severity-high)' : 'var(--severity-low)' }}>
                        {comm.fillerWordsCount}
                      </span>
                      <span style={{ color: 'var(--text-muted)' }}>words flagged</span>
                    </div>
                  ...
                  <div className="interview-card" style={{ padding: '1.5rem' }}>
                    <h3 style={{ fontSize: '1rem', color: 'var(--text-muted)', margin: '0 0 1rem 0', textTransform: 'uppercase' }}>Speaking Pace</h3>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                      <span style={{ fontSize: '2.5rem', fontWeight: 'bold', color: 'var(--accent)', textTransform: 'capitalize' }}>
                        {comm.pace}
                      </span>
                    </div>
                    <p style={{ margin: '0.5rem 0 0 0', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                ...
                {rounds.map((round, idx) => (
                  <div key={idx} className="interview-card" style={{ padding: '1.5rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.75rem', marginBottom: '1rem' }}>
                      <span style={{ fontWeight: 'bold', fontSize: '1.1rem', color: 'var(--accent)' }}>Round {idx + 1} Evaluation</span>
                    ...
                    <div style={{ marginBottom: '1rem' }}>
                      <p style={{ fontWeight: 'bold', fontSize: '0.9rem', color: 'var(--text-muted)', margin: '0 0 0.25rem 0' }}>QUESTION</p>
                      <p style={{ color: 'var(--text-primary)', margin: 0, fontSize: '0.95rem' }}>{round.question}</p>
                    </div>

                    {/* A */}
                    <div style={{ marginBottom: '1rem', background: 'var(--info-bg)', padding: '0.8rem', borderRadius: '6px', borderLeft: '3px solid var(--border-color)' }}>
                      <p style={{ fontWeight: 'bold', fontSize: '0.9rem', color: 'var(--text-muted)', margin: '0 0 0.25rem 0' }}>YOUR RESPONSE</p>
                      <p style={{ color: 'var(--text-muted)', margin: 0, fontSize: '0.95rem' }}>{round.answer}</p>
                    </div>

                    {/* Feedback */}
                    <div>
                      <p style={{ fontWeight: 'bold', fontSize: '0.9rem', color: 'var(--text-muted)', margin: '0 0 0.25rem 0' }}>COACH FEEDBACK</p>
                      <p style={{ color: 'var(--text-muted)', margin: 0, fontSize: '0.95rem', lineHeight: '1.5' }}>{round.feedback}</p>
                    </div>
                  </div>
                ))}
              </div>
