...
import { analyzeResume, getResumeHistory } from "@/services/saas.api";
  ...
  return (
    <Protected>
      ...
      >
        ...
        >
          <h1>
            AI Resume <span className="highlight">ATS Analyzer</span>
          </h1>
          <p>
            Scan your resume against any target job description. Uncover
            formatting issues, missing keywords, and weak bullet points
            instantly.
          </p>
        </header>
          ...
          >
            ...
            >
              ...
              <div className="interview-card" style={{ padding: "2rem" }}>
                ...
                >
                  {report.weakBulletPoints &&
                  report.weakBulletPoints.length > 0 ? (
                    ...
                    <p style={{ color: "#888", margin: 0 }}>
                      No weak bullet points were identified! Nice job.
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="interview-card" style={{ padding: "2rem" }}>
                ...
                >
                  ...
                  report.formattingProblems.length > 0 ? (
                    ...
                    >
                      ✓ No critical formatting issues found. Perfect for ATS
                      parsing!
                    </li>
                  )}
                </ul>
              ...
              <div className="interview-card" style={{ padding: "2rem" }}>
                ...
                >
                  {report.experienceQualityReport ||
                    "No additional summary text available."}
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="match-score-widget">
                ...
                <div
                  className={`match-score-widget__ring ${report.atsScore >= 80 ? "score--high" : report.atsScore >= 60 ? "score--mid" : "score--low"}`}
                >
                  <span className="match-score-widget__value">
                    {report.atsScore || 0}
                  </span>
                  <span className="match-score-widget__pct">%</span>
                </div>
                <p className="match-score-widget__sub">
                  Score calculated from keyword alignment.
                </p>
              </div>
              ...
              <div className="interview-card" style={{ padding: "1.5rem" }}>
                ...
                >
                  ...
                  report.missingKeywords.length > 0 ? (
                    ...
                    >
                      ✓ All critical job-description keywords are present!
                    </span>
                  )}
                </div>
              </div>
